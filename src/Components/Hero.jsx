      ...
      <div className="hero-container">
        ...
        >
          ...
          <motion.div className="social-links" variants={staggerContainer}>
            ...
            <motion.a target="_blank" href="https://www.linkedin.com/">
              <i className="fab fa-linkedin" />
            </motion.a>
            <motion.a target="_blank" href="https://twitter.com/">
        ...
        >
          <div className="code-display">
            ...
            >
              {`const aboutMe = {
              name: "Prem Goswami",
              title: "Full Stack Developer | AWS Certified Solutions Architect (SAA-C03)",
              coreSkills: [
              ...
              "My mission is to leverage full-stack development, cloud computing (AWS),
              and automation to build efficient, scalable, and secure web applications.
              By integrating robust APIs, optimizing system performance, and fostering
              collaborative development, I aim to deliver impactful software solutions
